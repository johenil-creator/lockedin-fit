...
const styles = StyleSheet.create({
  ...
  sidebar: { width: 140, borderRightWidth: 1, paddingTop: 8 },
  sidebarTitle: { fontSize: 10, fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.8, paddingHorizontal: 12, marginBottom: 8 },
  exerciseItem: { paddingVertical: 10, paddingHorizontal: 12, borderRadius: 6, marginHorizontal: 6, marginBottom: 2 },
  ...
  summaryCard: { flex: 1, borderRadius: 10, padding: 12, alignItems: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 3, elevation: 2 },
